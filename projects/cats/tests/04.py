  ...
  'suites': [
    {
      'cases': [
        ...
        },
        {
          ...
          >>> round(wpm(entered_string1, 67), 1)
          99.2
          >>> round(wpm(entered_string2, 67), 1)
          98.9
          >>> round(wpm(entered_string3, 67), 1)
          2.1
          >>> round(wpm(entered_string4, 67), 1)
          100.3
          >>> round(wpm(entered_string5, 67), 1)
          199.3
          >>> round(wpm(entered_string6, 1), 1)
          132.0
          """,
          'hidden': False,
          'locked': False,
